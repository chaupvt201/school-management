...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Danh sách môn học đăng ký cho lớp</h1>
          </div> 
          <div class="col-sm-6" style="text-align: right;"> 
          <a href="{{ url('admin/assign_subject/add')}}" class="btn btn-primary">Đăng ký môn học</a> 
          </div>
        ...
        <div class="row">
          ...
          <!--/.col (right) -->
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Danh sách môn học theo lớp</h3>
              </div>
              <!-- /.card-header -->
